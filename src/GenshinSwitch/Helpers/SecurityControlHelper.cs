...
internal static class SecurityControlHelper
{
    public static void AllowFullFileSecurity(string filePath)
    {
        ...
        {
            Logger.Error(e);
            NoticeService.AddNotice("Allow Full File Security Error", e.ToString());
        }
    }
    ...
    public static void AllowFullFolderSecurity(string dirPath)
    {
        ...
        {
            Logger.Error(e);
            NoticeService.AddNotice("Allow Full Folder Security Error", e.ToString());
        }
    }

    public static void AllowFullFolderSecurity()
    {
        AllowFullFolderSecurity(new FileInfo(Environment.ProcessPath!).Directory!.FullName);
    }
}
